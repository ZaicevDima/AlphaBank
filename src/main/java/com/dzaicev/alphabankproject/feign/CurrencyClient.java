...
public interface CurrencyClient {
    ...
    public ResponseEntity<Map> getCurrencyFromDateInfo(@PathVariable String date, @PathVariable String currencyId, @PathVariable String base, @PathVariable String symbol);
}
